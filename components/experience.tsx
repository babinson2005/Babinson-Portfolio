  ...
  const experiences = [
    {
      ...
      skills: ["Machine Learning", "Feature Engineering", "Python", "Data Analysis"],
    },
    {
      title: "Soccer Coach",
      company: "TNSC",
    ...
    },
    {
      ...
      skills: ["ReactJS", "SQL", "Web Development", "Team Leadership", "UI/UX Design"],
    },
    {
      title: "Data Analyst",
      ...
      skills: ["Python", "Machine Learning", "Pandas", "scikit-learn", "Mentorship"],
    },
    {
                ...
                <Card className="relative overflow-hidden border-l-4 border-l-green-600">
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant="outline" className="ml-2 border-green-500/30">
                        {exp.period}
                      </Badge>
                    </div>
                  </CardHeader>

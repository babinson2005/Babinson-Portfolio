  ...
  const projects = [
    {
      ...
      images: [
        {
          src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/qutabletennis-home.png",
      ...
      longDescription:
        "Designed and built a responsive website for the Queen's Table Tennis Club using Next.js and CSS. Focused on creating a clean and intuitive interface for students to access schedules, events, and contact information. Deployed via Vercel to ensure fast load times and reliable uptime.",
    },
    {
      id: 2,
      ...
      longDescription:
        "Developed a responsive, user-friendly website for Queen's Cricket Club using ReactJS and CSS. Coordinated with stakeholders to define requirements and implemented features that improved usability by 30%. Deployed the website on Netlify for fast and reliable hosting.",
    },
    {
      id: 3,
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Here's a selection of my recent work across various domains and technologies. Click on any project to learn
            more.
          </p>
                ...
                <Card className="overflow-hidden border-green-500/10 h-full cursor-pointer">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      <Badge variant="outline" className="capitalize border-green-500/30">
                        {project.category}
                      </Badge>
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            >
              <ImageCarousel images={selectedProject.images} className="w-full" />
              <div className="p-6">

        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter">
            ...
            <span className="relative">
              ...
              <motion.span
                className="absolute bottom-0 left-0 w-full h-3 bg-green-500/30 -z-10"
                initial={{ width: 0 }}
                animate={{ width: "100%" }}
          ...
          >
            I'm a <TypewriterEffect words={["Developer", "Student", "Creator"]} /> passionate about building beautiful,
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground italic">
        This portfolio is continuously updated with my latest projects and skills.
      </p>
    </motion.div>
  )
}

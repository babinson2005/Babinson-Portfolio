        ...
        >
          ...
          >
            <div className="relative">
              <div className="absolute -inset-4 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 opacity-30 blur-xl" />
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              I'm a passionate Computing student at Queen's University with a keen eye for design and a love for
              creating seamless user experiences. I specialize in building modern, responsive websites and applications
              using various programming languages and tools.
            </p>

            <p className="text-muted-foreground leading-relaxed">
              When I'm not coding, you can find me exploring new technologies, contributing to projects at Queen's, or
            ...
            <p className="text-muted-foreground leading-relaxed font-medium">
              This portfolio is a living document of my journey. I'm constantly updating it with new projects, skills,
              and experiences as I grow in my career.
            </p>
            ...
            <div className="flex flex-col gap-4 pt-4">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button
                  ...
                  size="icon"
                  className="rounded-full border-violet-500 hover:bg-violet-500/10"
                  onClick={() => window.open("mailto:bobbybatala320@gmail.com", "_blank")}
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6">
              <Card className="bg-background/50 backdrop-blur-sm border-violet-500/20">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">GPA (out of 4.3)</p>
                </CardContent>
              </Card>
              <Card className="bg-background/50 backdrop-blur-sm border-violet-500/20">
                <CardContent className="p-4 text-center">
